...
public class AbTwoColumnListView extends LinearLayout {
	...
	public AbTwoColumnListView(Context context, AttributeSet attrs,int defStyle) {
		...
		mainLayout.addView(firstColumn, new LayoutParams(0,LayoutParams.WRAP_CONTENT, 1));
		mainLayout.addView(secondColumn, new LayoutParams(0,LayoutParams.WRAP_CONTENT, 1));

		this.addView(mainLayout, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
