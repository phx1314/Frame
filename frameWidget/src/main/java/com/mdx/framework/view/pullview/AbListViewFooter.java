...
public class AbListViewFooter extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        footerProgressBar.setVisibility(View.GONE); if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        footerProgressBar.setIndeterminateTintList(ColorStateList.valueOf(Color.parseColor(COLOR)));
    ...
    public void setColor() { if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        footerProgressBar.setIndeterminateTintList(ColorStateList.valueOf(Color.parseColor(COLOR)));
    }
}
