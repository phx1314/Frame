...
public class AbListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
            headerProgressBar.setIndeterminateTintList(ColorStateList.valueOf(Color.parseColor(COLOR)));

        LayoutParams layoutParamsWW = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        layoutParamsWW.gravity = Gravity.CENTER;
        layoutParamsWW.width = (int) AbViewUtil.dip2px(getContext(), 25);
        layoutParamsWW.height = (int) AbViewUtil.dip2px(getContext(), 25);
        ...
        headTextLayout.setPadding((int) AbViewUtil.dip2px(getContext(), 10), 0, 0, 0);
        LayoutParams layoutParamsWW2 = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        layoutParamsWW2.gravity = Gravity.CENTER_HORIZONTAL;
